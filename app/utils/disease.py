disease_dic = {
    ...
    'Cherry___Powdery_mildew': """ <b>Crop</b>: Cherry <br/>Disease: Powdery Mildew<br/>
        <br/> Cause of disease:
    ...
    'Cherry___healthy': """ <b>Crop</b>: Cherry <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Corn___Cercospora_leaf_spot Gray_leaf_spot': """ <b>Crop</b>: Corn <br/>Disease: Grey Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Corn___Common_rust_': """ <b>Crop</b>: Corn(maize) <br/>Disease: Common Rust<br/>
        <br/> Cause of disease:
    ...
    'Corn___Northern_Leaf_Blight': """ <b>Crop</b>: Corn(maize) <br/>Disease: Northern Leaf Blight
        <br/>
        <br/> Cause of disease:
    ...
    'Corn___healthy': """ <b>Crop</b>: Corn(maize) <br/>Disease: No disease<br/>
